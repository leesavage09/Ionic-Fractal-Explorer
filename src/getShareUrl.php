...
<head>
  ...
  <meta property="og:image" content="https://fractal-explorer-leesavage.herokuapp.com/getShareJpg.php?id=<?php echo $id; ?>">
  <meta property="og:url" content="https://fractal-explorer-leesavage.herokuapp.com">
...
<script>
    window.location.replace("https://fractal-explorer-leesavage.herokuapp.com/<?php echo $url; ?>");
</script>
